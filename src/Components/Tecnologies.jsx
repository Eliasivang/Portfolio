  ...
  return (
   <>
        ...
        <Tooltip anchorId="html-logo" content="HTML" style={{ color: 'rgb(255, 97, 0)' }}/>
         <a id='html-logo' ><FaHtml5  className='text-6xl text-green-400 hover:text-violet-800'/></a>
         <Tooltip anchorId="css-logo" content="CSS" style={{ color: 'rgb(0, 39, 255)' }} />
         <a id="css-logo"><FaCss3Alt className='text-6xl text-green-400 hover:text-violet-800'/></a>
         ...
         <a id='js-logo'><IoLogoJavascript className='text-6xl text-green-400 hover:text-violet-800'/></a>
         <Tooltip anchorId="react-logo" content="React" style={{ color: 'rgb(0, 116, 255)' }} />
         <a id='react-logo'><FaReact className='text-6xl text-green-400 hover:textviotext-violet-800'/></a>
         ...
         <a id='sass-logo'><FaSass className='text-6xl text-green-400 hover:text-violet-800'/></a>
         <Tooltip anchorId="framer-logo" content="Framer Motion" style={{ color: 'rgb(250,49,162)' }}/>
         <a id='framer-logo'><SiFramer className='text-6xl text-green-400 hover:text-violet-800'/></a>
